 ...
 * under the License.
 */
package com.just.server.http.file;
...
public class HttpStaticFileServerHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    private static void setContentTypeHeader(HttpResponse response, File file) {
        ...
        if((dot_pos>0)&&file.getPath().substring(dot_pos+1).toLowerCase().equals("css")){
            System.out.println(file.getPath().substring(dot_pos + 1));
